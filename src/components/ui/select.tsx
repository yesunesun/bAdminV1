...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-14 w-full items-center justify-between rounded-xl border border-slate-200 bg-white px-5 py-4 text-base transition-all",
  ...
  >
    ...
    <SelectPrimitive.Icon asChild>
      <ChevronDown className="h-5 w-5 text-slate-400 transition-transform duration-200 ease-in-out group-data-[state=open]:rotate-180" />
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex w-full cursor-pointer select-none items-center rounded-lg py-3 px-4 text-base outline-none transition-colors",
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn("py-2 px-4 text-sm font-medium text-slate-500", className)}
    {...props}
  />
))
