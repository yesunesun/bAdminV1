...
CREATE POLICY "Super admins can manage roles"
    ...
    USING (
        EXISTS (
            ...
            AND ar.role_type = 'super_admin'::admin_role_type
        )
    );
...
BEGIN
    ...
    VALUES ('super_admin'::admin_role_type)
    ON CONFLICT DO NOTHING
    RETURNING id INTO v_role_id;

    -- If role_id is null (meaning it already existed), get it
    IF v_role_id IS NULL THEN
        SELECT id INTO v_role_id FROM admin_roles WHERE role_type = 'super_admin'::admin_role_type;
    END IF;
